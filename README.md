...
Modeling the statutes and training documents as a heterogeneous graph, our proposed model {\bf LeSICiN} can learn rich textual and graphical features, and can also tune itself to correlate these features. 
